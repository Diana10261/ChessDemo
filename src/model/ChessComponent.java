 ...
 */
public abstract class ChessComponent extends JComponent implements MouseListener {
...
//    protected void possibility(Graphics g, ChessComponent chessComponent){
//        super.paintComponent(g);
//        g.setColor(Color.GREEN);
//        g.fillRect(chessComponent.getX(),chessComponent.getY(),this.getWidth()/8,this.getHeight()/8);
//    }
